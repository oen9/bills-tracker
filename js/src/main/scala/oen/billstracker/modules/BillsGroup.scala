          ...
          <.ul(^.cls := "list-group",
            <.li(^.cls := "list-group-item", 
              <.div(^.cls := "row align-items-center", 
                <.div(^.cls := "col-sm col-md-8", "bread"),
                <.div(^.cls := "col-sm col-md-2", "2.99"),
                <.div(^.cls := "col-sm col-md-2", 
            ...
            <.li(^.cls := "list-group-item", 
              <.form(
                <.div(^.cls := "row align-items-center", 
                    <.div(^.cls := "col-sm col-md-8", <.input(^.tpe := "text", ^.cls := "form-control", ^.value := "bread")),
                    <.div(^.cls := "col-sm col-md-2", <.input(^.tpe := "text", ^.cls := "form-control", ^.value := "2.99")),
                  <.div(^.cls := "col-sm col-md-2", 
                    <.div(^.cls := "btn-group", ^.role := "group",
